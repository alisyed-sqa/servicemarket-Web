/**
 * HomeCleaningPage - Page Object for One-Time Home Cleaning Booking
 *
 * This page object automates the complete booking flow for a ONE-TIME
 * home cleaning service on ServiceMarket. The booking steps are:
 *   1. Navigate to the Home Cleaning service page
 *   2. Click "Book Now"
 *   3. Select options: 2 hours duration, ONCE frequency
...
export class HomeCleaningPage extends BasePage {
  // --- Element Selectors ---
  ...
  readonly frequencyLabel = 'label[for="howOften-ONCE"]';                                 // "Once" frequency option
  ...
  async navigateToHomeCleaning() {
    console.log('Step 5: Navigating to Home Cleaning...');
  ...
  /** Step 7: Select 2 hours duration and ONCE frequency, then click Next */
  async selectBookingOptions() {
    ...
    // Select frequency: ONCE (one-time booking)
